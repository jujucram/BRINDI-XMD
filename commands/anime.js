...
async function animeCommand(sock, chatId, message, args) {
    ...
    try {
        ...
        if (!supported.includes(sub)) {
            await sock.sendMessage(chatId, { text: `❌ Unsupported type: ${sub}. Try one of: ${supported.join(', ')}\n> BRINDI-XMD` }, { quoted: message });
            return;
        }
        ...
        await sock.sendMessage(chatId, { text: `❌ Une erreur est survenue lors de fetching animu.\n> BRINDI-XMD` }, { quoted: message });
    }
}
